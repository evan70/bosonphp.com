 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:le,defineProperty:de,getOwnPropertyDescriptor:ce,getOwnPropertyNames:he,getOwnPropertySymbols:pe,getPrototypeOf:me}=Object,z=globalThis,F=z.trustedTypes,ue=F?F.emptyScript:"",ge=z.reactiveElementPolyfillSupport,E=(n,e)=>n,j={toAttribute(n,e){switch(e){case Boolean:n=n?ue:null;break;case Object:case Array:n=n==null?n:JSON.stringify(n)}return n},fromAttribute(n,e){let t=n;switch(e){case Boolean:t=n!==null;break;case Number:t=n===null?null:Number(n);break;case Object:case Array:try{t=JSON.parse(n)}catch{t=null}}return t}},te=(n,e)=>!le(n,e),G={attribute:!0,type:String,converter:j,reflect:!1,useDefault:!1,hasChanged:te};Symbol.metadata??=Symbol("metadata"),z.litPropertyMetadata??=new WeakMap;let _=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=G){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const i=Symbol(),s=this.getPropertyDescriptor(e,i,t);s!==void 0&&de(this.prototype,e,s)}}static getPropertyDescriptor(e,t,i){const{get:s,set:o}=ce(this.prototype,e)??{get(){return this[t]},set(r){this[t]=r}};return{get:s,set(r){const m=s?.call(this);o?.call(this,r),this.requestUpdate(e,m,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??G}static _$Ei(){if(this.hasOwnProperty(E("elementProperties")))return;const e=me(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(E("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(E("properties"))){const t=this.properties,i=[...he(t),...pe(t)];for(const s of i)this.createProperty(s,t[s])}const e=this[Symbol.metadata];if(e!==null){const t=litPropertyMetadata.get(e);if(t!==void 0)for(const[i,s]of t)this.elementProperties.set(i,s)}this._$Eh=new Map;for(const[t,i]of this.elementProperties){const s=this._$Eu(t,i);s!==void 0&&this._$Eh.set(s,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const s of i)t.unshift(q(s))}else e!==void 0&&t.push(q(e));return t}static _$Eu(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ae(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ET(e,t){const i=this.constructor.elementProperties.get(e),s=this.constructor._$Eu(e,i);if(s!==void 0&&i.reflect===!0){const o=(i.converter?.toAttribute!==void 0?i.converter:j).toAttribute(t,i.type);this._$Em=e,o==null?this.removeAttribute(s):this.setAttribute(s,o),this._$Em=null}}_$AK(e,t){const i=this.constructor,s=i._$Eh.get(e);if(s!==void 0&&this._$Em!==s){const o=i.getPropertyOptions(s),r=typeof o.converter=="function"?{fromAttribute:o.converter}:o.converter?.fromAttribute!==void 0?o.converter:j;this._$Em=s;const m=r.fromAttribute(t,o.type);this[s]=m??this._$Ej?.get(s)??m,this._$Em=null}}requestUpdate(e,t,i){if(e!==void 0){const s=this.constructor,o=this[e];if(i??=s.getPropertyOptions(e),!((i.hasChanged??te)(o,t)||i.useDefault&&i.reflect&&o===this._$Ej?.get(e)&&!this.hasAttribute(s._$Eu(e,i))))return;this.C(e,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:i,reflect:s,wrapped:o},r){i&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,r??t??this[e]),o!==!0||r!==void 0)||(this._$AL.has(e)||(this.hasUpdated||i||(t=void 0),this._$AL.set(e,t)),s===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[s,o]of this._$Ep)this[s]=o;this._$Ep=void 0}const i=this.constructor.elementProperties;if(i.size>0)for(const[s,o]of i){const{wrapped:r}=o,m=this[s];r!==!0||this._$AL.has(s)||m===void 0||this.C(s,void 0,o,m)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(t)):this._$EM()}catch(i){throw e=!1,this._$EM(),i}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};_.elementStyles=[],_.shadowRootOptions={mode:"open"},_[E("elementProperties")]=new Map,_[E("finalized")]=new Map,ge?.({ReactiveElement:_}),(z.reactiveElementVersions??=[]).push("2.1.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const D=globalThis,M=D.trustedTypes,Y=M?M.createPolicy("lit-html",{createHTML:n=>n}):void 0,ie="$lit$",y=`lit$${Math.random().toFixed(9).slice(2)}$`,se="?"+y,fe=`<${se}>`,w=document,P=()=>w.createComment(""),C=n=>n===null||typeof n!="object"&&typeof n!="function",W=Array.isArray,ve=n=>W(n)||typeof n?.[Symbol.iterator]=="function",U=`[ 	
\f\r]`,k=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,K=/-->/g,J=/>/g,b=RegExp(`>|${U}(?:([^\\s"'>=/]+)(${U}*=${U}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Z=/'/g,X=/"/g,ne=/^(?:script|style|textarea|title)$/i,xe=n=>(e,...t)=>({_$litType$:n,strings:e,values:t}),l=xe(1),A=Symbol.for("lit-noChange"),g=Symbol.for("lit-nothing"),Q=new WeakMap,$=w.createTreeWalker(w,129);function oe(n,e){if(!W(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return Y!==void 0?Y.createHTML(e):e}const ye=(n,e)=>{const t=n.length-1,i=[];let s,o=e===2?"<svg>":e===3?"<math>":"",r=k;for(let m=0;m<t;m++){const a=n[m];let u,f,d=-1,v=0;for(;v<a.length&&(r.lastIndex=v,f=r.exec(a),f!==null);)v=r.lastIndex,r===k?f[1]==="!--"?r=K:f[1]!==void 0?r=J:f[2]!==void 0?(ne.test(f[2])&&(s=RegExp("</"+f[2],"g")),r=b):f[3]!==void 0&&(r=b):r===b?f[0]===">"?(r=s??k,d=-1):f[1]===void 0?d=-2:(d=r.lastIndex-f[2].length,u=f[1],r=f[3]===void 0?b:f[3]==='"'?X:Z):r===X||r===Z?r=b:r===K||r===J?r=k:(r=b,s=void 0);const x=r===b&&n[m+1].startsWith("/>")?" ":"";o+=r===k?a+fe:d>=0?(i.push(u),a.slice(0,d)+ie+a.slice(d)+y+x):a+y+(d===-2?m:x)}return[oe(n,o+(n[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};class H{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let o=0,r=0;const m=e.length-1,a=this.parts,[u,f]=ye(e,t);if(this.el=H.createElement(u,i),$.currentNode=this.el.content,t===2||t===3){const d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(s=$.nextNode())!==null&&a.length<m;){if(s.nodeType===1){if(s.hasAttributes())for(const d of s.getAttributeNames())if(d.endsWith(ie)){const v=f[r++],x=s.getAttribute(d).split(y),T=/([.?@])?(.*)/.exec(v);a.push({type:1,index:o,name:T[2],strings:x,ctor:T[1]==="."?$e:T[1]==="?"?we:T[1]==="@"?_e:N}),s.removeAttribute(d)}else d.startsWith(y)&&(a.push({type:6,index:o}),s.removeAttribute(d));if(ne.test(s.tagName)){const d=s.textContent.split(y),v=d.length-1;if(v>0){s.textContent=M?M.emptyScript:"";for(let x=0;x<v;x++)s.append(d[x],P()),$.nextNode(),a.push({type:2,index:++o});s.append(d[v],P())}}}else if(s.nodeType===8)if(s.data===se)a.push({type:2,index:o});else{let d=-1;for(;(d=s.data.indexOf(y,d+1))!==-1;)a.push({type:7,index:o}),d+=y.length-1}o++}}static createElement(e,t){const i=w.createElement("template");return i.innerHTML=e,i}}function S(n,e,t=n,i){if(e===A)return e;let s=i!==void 0?t._$Co?.[i]:t._$Cl;const o=C(e)?void 0:e._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(n),s._$AT(n,t,i)),i!==void 0?(t._$Co??=[])[i]=s:t._$Cl=s),s!==void 0&&(e=S(n,s._$AS(n,e.values),s,i)),e}class be{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,s=(e?.creationScope??w).importNode(t,!0);$.currentNode=s;let o=$.nextNode(),r=0,m=0,a=i[0];for(;a!==void 0;){if(r===a.index){let u;a.type===2?u=new B(o,o.nextSibling,this,e):a.type===1?u=new a.ctor(o,a.name,a.strings,this,e):a.type===6&&(u=new Ae(o,this,e)),this._$AV.push(u),a=i[++m]}r!==a?.index&&(o=$.nextNode(),r++)}return $.currentNode=w,s}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class B{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=g,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=S(this,e,t),C(e)?e===g||e==null||e===""?(this._$AH!==g&&this._$AR(),this._$AH=g):e!==this._$AH&&e!==A&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ve(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==g&&C(this._$AH)?this._$AA.nextSibling.data=e:this.T(w.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:i}=e,s=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=H.createElement(oe(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(t);else{const o=new be(s,this),r=o.u(this.options);o.p(t),this.T(r),this._$AH=o}}_$AC(e){let t=Q.get(e.strings);return t===void 0&&Q.set(e.strings,t=new H(e)),t}k(e){W(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,s=0;for(const o of e)s===t.length?t.push(i=new B(this.O(P()),this.O(P()),this,this.options)):i=t[s],i._$AI(o),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const i=e.nextSibling;e.remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class N{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,o){this.type=1,this._$AH=g,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=g}_$AI(e,t=this,i,s){const o=this.strings;let r=!1;if(o===void 0)e=S(this,e,t,0),r=!C(e)||e!==this._$AH&&e!==A,r&&(this._$AH=e);else{const m=e;let a,u;for(e=o[0],a=0;a<o.length-1;a++)u=S(this,m[i+a],t,a),u===A&&(u=this._$AH[a]),r||=!C(u)||u!==this._$AH[a],u===g?e=g:e!==g&&(e+=(u??"")+o[a+1]),this._$AH[a]=u}r&&!s&&this.j(e)}j(e){e===g?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class $e extends N{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===g?void 0:e}}class we extends N{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==g)}}class _e extends N{constructor(e,t,i,s,o){super(e,t,i,s,o),this.type=5}_$AI(e,t=this){if((e=S(this,e,t,0)??g)===A)return;const i=this._$AH,s=e===g&&i!==g||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,o=e!==g&&(i===g||s);s&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class Ae{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){S(this,e)}}const Se=D.litHtmlPolyfillSupport;Se?.(H,B),(D.litHtmlVersions??=[]).push("3.3.1");const ke=(n,e,t)=>{const i=t?.renderBefore??e;let s=i._$litPart$;if(s===void 0){const o=t?.renderBefore??null;i._$litPart$=s=new B(e.insertBefore(P(),o),o,void 0,t??{})}return s._$AI(n),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const L=globalThis;class c extends _{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=ke(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return A}}c._$litElement$=!0,c.finalized=!0,L.litElementHydrateSupport?.({LitElement:c});const Ee=L.litElementPolyfillSupport;Ee?.({LitElement:c});(L.litElementVersions??=[]).push("4.2.1");const p=h`
  h1, h2, h3, h4, h5, h6 {
...
`;class Pe extends c{static styles=[p,h`
    .container {
      aspect-ratio: 1 / 1;
      position: relative;
      height: 100%;
  ...
  `];render(){return l`
        ...
        `}}customElements.define("dots-container",Pe);class Ce extends c{static properties={href:{type:String},external:{type:Boolean}};static styles=[p,h`
    .button {
      height: inherit;
    ...
    `];constructor(){super(),this.href="/",this.external=!1}render(){return l`
        ...
        `}}customElements.define("boson-header-button",Ce);class He extends c{static properties={href:{type:String},external:{type:Boolean},active:{type:Boolean}};static styles=[p,h`
    .link {
      color: var(--color-paragraph-1);
    ...
    `];constructor(){super(),this.href="/",this.external=!1,this.active=!1}render(){return l`
        ...
        `}}customElements.define("boson-header-link",He);class Be extends c{static properties={};static styles=[p,h`
    details > summary {
      list-style-type: '';
    }
    ...
    `];constructor(){super()}onMouseEnter(e){e.target.setAttribute("open","open")}onMouseLeave(e){e.target.removeAttribute("open")}render(){return l`
        ...
        `}}customElements.define("boson-header-dropdown",Be);class Te extends c{static properties={isScrolled:{type:Boolean},isDocsOpen:{type:Boolean}};static styles=[p,h`
    .container {
      height: 100px;
      line-height: 100px;
      position: fixed;
  ...
  `];constructor(){super(),this.isScrolled=!1,this.isDocsOpen=!1,this.handleScroll=this.handleScroll.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("scroll",this.handleScroll),this.handleScroll()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("scroll",this.handleScroll)}handleScroll(){const e=window.pageYOffset||document.documentElement.scrollTop;this.isScrolled=e>0}render(){return l`
        ...
        `}}customElements.define("app-header",Te);class Oe extends c{static styles=[p,h`
    .container {
      display: flex;
      flex-direction: column;
    }
  ...
  `];render(){return l`
    ...
    `}}customElements.define("app-footer",Oe);class Me extends c{static properties={href:{type:String},text:{type:String}};static styles=[p,h`
    .button {
      transition-duration: 0.2s;
  ...
  `];constructor(){super(),this.href="/",this.text=""}render(){return l`
    ...
    `}}customElements.define("button-secondary",Me);class ze extends c{static properties={href:{type:String},text:{type:String}};static styles=[p,h`
    .button {
      transition-duration: 0.2s;
  ...
  `];constructor(){super(),this.href="/",this.text=""}render(){return l`
    ...
    `}}customElements.define("button-primary",ze);class Ne extends c{static styles=[p,h`
    .container {
      display: flex;
      flex-direction: column;
  ...
  `];render(){return l`
      <section class="container">
        <div class="top">
          <div class="text">
            ...
            <p class="description">Turn your PHP project into cross-platform, compact, fast, native applications for Windows, macOS, Linux, Android and iOS.</p>
            <div class="buttons">
    ...
    `}}customElements.define("hero-section",Ne);class Ue extends c{static properties={name:{type:String}};static styles=[p,h`
    .container {
      display: flex;
      gap: 1em;
      justify-content: center;
  ...
  `];constructor(){super(),this.name=""}render(){return l`
    ...
    `}}customElements.define("subtitle-component",Ue);class je extends c{static styles=[p,h`
    .container {
      display: flex;
      flex-direction: column;
      margin-bottom: 2em;
  ...
  `];render(){return l`
    ...
    `}}customElements.define("nativeness-section",je);class Ie extends c{static styles=[p,h`
    .container {
      display: flex;
      flex-direction: column;
      gap: 4em;
  ...
  `];render(){return l`
        ...
        <div class="top">
          ...
          <div class="right">
            <div class="el">
              ...
              <p>Compile an application for the desired desktop platform based on an existing PHP project.</p>
            </div>
            <div class="el">
              <img src="/images/icons/check.svg" alt="check"/>
        ...
        <div class="content">
          ...
          <div class="inner">
            <div class="solves">
              ...
              <p>Pride in your favorite language, which is not dying! A real desire to create something useful and interesting. Boson will allow you to create applications from scratch, as a framework.</p>
            </div>
            <div class="solves">
              <img src="/images/icons/lock.svg" alt="lock"/>
              <h2>For business</h2>
              <p>Desktop application – getting different variants of working applications. Mobile application – expand profits by getting a new segment of the mobile application market.</p>
            </div>
            <div class="solves">
              <img src="/images/icons/web.svg" alt="web"/>
              <h2>For web studios</h2>
              <p>No need to expand your staff to make applications for different platforms, work with Bosob and increase your income.</p>
            </div>
          </div>
          <div class="dots">
            <dots-container></dots-container>
    ...
    `}}customElements.define("solves-section",Ie);class Re extends c{static properties={content:{type:Array},openIndex:{type:Number}};static styles=[p,h`
    .accordion {
      display: flex;
      height: 24rem;
      flex: 1;
  ...
  `];constructor(){super(),this.content=[],this.openIndex=0}handleElementClick(e){this.openIndex=e}renderElement(e,t){const i=this.openIndex===t;return l`
    ...
    `}}customElements.define("horizontal-accordion",Re);class De extends c{static styles=[p,h`
    .container {
      display: flex;
      flex-direction: column;
      gap: 4em;
  ...
  `];get content(){return[{headline:"Saucer: The Core of Performance",text:"At the heart of Boson PHP is saucer, a fast cross-platform C++ library. It allows us to create applications with minimal size and resource consumption, significantly outperforming Electron in terms of performance."},{headline:"Saucer: The Core of Performance",text:"At the heart of Boson PHP is saucer, a falications with minimal size and resource consumption, significantly outperforming Electron in terms of performance."},{headline:"Saucer: The Core of Performance",text:"At the heart of Boson antly outperforming Electron in terms of performance."},{headline:"Saucer: The Core of Performance",text:"At the heart of to create applications with minimal size and resource consumption, significantly outperforming Electron in terms of performance."},{headline:"Saucer: The Core of Performance",text:"At the heart of Boson PHP is saucer, a fast cross-platform C++ library. It allows us to create and resource consumption, significantly outperforming Electron in terms of performance."}]}render(){return l`
      <section class="container">
        <div class="top">
          ...
          <div class="right">
            ...
            <p>Want to know what makes Boson PHP so compact, fast and versatile? We don't use Electron. Instead, our solution is based on simple, yet robust and up-to-date technologies that provide native performance and lightweight across all platforms.</p>
          </div>
        </div>
        <div class="content">
          <div class="dots">
    ...
    `}}customElements.define("how-it-works-section",De);class We extends c{static styles=[p,h`
    .container {
  ...
  `];render(){return l`
    ...
    `}}customElements.define("right-choice-section",We);class Le extends c{static styles=[p,h`
    .container {
      display: flex;
      justify-content: center;
      position: relative;
  ...
  `];get elements(){return[{text:"For many businesses, mobile devices are the main audience segment. Web applications are good. Desktop clients are great. Mobile applications are wonderful.",icon:"rocket",headline:"Reaching new audiences"},{text:"The same PHP code — but now it works on a mobile device. Budget savings and faster launch.",icon:"clients",headline:"New clients without rewriting code"},{headline:"Convenient for B2B and B2C",icon:"case",text:"Internal CRM, chat applications, offline utilities, task managers, task trackers, dashboards — you can carry everything in your pocket."},{headline:"Without pain and extra stacks",icon:"convenient",text:"One stack. One language. One project. PHP from start to launch in the App Store."}]}renderElement(e){return l`
    ...
    `}}customElements.define("mobile-development-section",Le);class Ve extends c{static properties={slides:{type:Array},currentIndex:{type:Number},slidesPerView:{type:Number}};static styles=[p,h`
    .container {
      display: flex;
      max-width: 100vw;
      overflow: hidden;
  ...
  `];constructor(){super(),this.slides=[],this.currentIndex=0,this.slidesPerView=1,this.autoplayInterval=null}connectedCallback(){super.connectedCallback(),this.updateSlidesPerView(),this.startAutoplay(),window.addEventListener("resize",this.updateSlidesPerView.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.stopAutoplay(),window.removeEventListener("resize",this.updateSlidesPerView.bind(this))}updateSlidesPerView(){this.slidesPerView=window.innerWidth>=768?3:1,this.requestUpdate()}startAutoplay(){this.stopAutoplay(),this.autoplayInterval=setInterval(()=>{this.slideNext()},3e3)}stopAutoplay(){this.autoplayInterval&&(clearInterval(this.autoplayInterval),this.autoplayInterval=null)}slidePrev(){this.currentIndex=this.currentIndex<=0?this.slides.length-this.slidesPerView:this.currentIndex-1,this.requestUpdate()}slideNext(){this.currentIndex=this.currentIndex>=this.slides.length-this.slidesPerView?0:this.currentIndex+1,this.requestUpdate()}getTransform(){const e=100/this.slidesPerView;return`translateX(-${this.currentIndex*e}%)`}renderSlide(e,t){return l`
    ...
    `}}customElements.define("slider-component",Ve);class qe extends c{static styles=[p,h`
    .container {
      position: relative;
      display: flex;
      flex-direction: column;
  ...
  `];get slides(){return[{name:"Alex Bondareev",pfp:"img.png",role:"Co-founder, Boson PHP",comment:"Building the future requires partners who make you feel like you're in it together. From our very first meeting, the Hartmann team has been actively involved, supporting our product development and business strategy and facilitating critical connections. Their deep understanding of gaming and spatial computing made them the ideal partner for us."},{name:"Alex Bondareev",pfp:"img.png",role:"Co-founder, Boson PHP",comment:"Building irst meeting, the Hartmann team has been actively involved, supporting our product development and business strategy and facilitating critical connections. Their deep understanding of gaming and spatial computing made them the ideal partner for us."},{name:"Alex Bondareev",pfp:"img.png",role:"Co-founder, Boson PHP",comment:"From our very first meeting, the Hartmann team has been actively involved, supporting our product development and business strategy and facilitating critical connections. Their deep understanding of gaming and spatial computing made them the ideal partner for us."},{name:"Alex Bondareev4",pfp:"img.png",role:"Co-founder, Boson PHP",comment:"Supporting our product development and business strategy and facilitating critical connections. Their deep understanding of gaming and spatial computing made them the ideal partner for us."},{name:"Alex Bondareev",pfp:"img.png",role:"Co-founder, Boson PHP",comment:"Building the future requires partners who make you feel like you're in it together. From our very first meeting, the Hartmann team has been actively involved, supporting our product development and business strategy and facilitating critical connections. Their deep understanding of gaming and spatial computing made them the ideal partner for us."},{name:"Alex Bondareev",pfp:"img.png",role:"Co-founder, Boson PHP",comment:"Building the future requires partners who make you feel like you're in it together. From our very first meeting, the Hartmann team has been actively involved, supporting our product development and business strategy and facilitating critical connections. Their deep understanding of gaming and spatial computing made them the ideal partner for us."},{name:"Alex Bondareev",pfp:"img.png",role:"Co-founder, Boson PHP",comment:"Building the future requires partners who make you feel like you're in it together. From our very first meeting, the Hartmann team has been actively involved, supporting our product development and business strategy and facilitating critical connections. Their deep understanding of gaming and spatial computing made them the ideal partner for us."}]}render(){return l`
    ...
    `}}customElements.define("testimonials-section",qe);class Fe extends c{static styles=[p,h`
    .container {
      padding-bottom: 8em;
  ...
  `];render(){return l`
    ...
    `}}customElements.define("call-to-action-section",Fe);class Ge extends c{static styles=[p,h`
        .page {
            display: flex;
            flex-direction: column;
            gap: 8em;
    ...
    `];render(){return l`
        ...
        `}}customElements.define("home-page",Ge);
